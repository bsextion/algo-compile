      ...
      <form className='space-y-6 px-6 px-4'>
        ...
        <div>
          ...
          <input
            ...
            name='email'
            id='email'
            className='bg-white border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white'
